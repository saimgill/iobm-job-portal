...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Lost password | Dynamic Admin Template</title>
        ...
        <div class="container login-container">
            <div class="login-panel panel panel-default plain animated bounceIn">
                ...
                <div class="panel-body">
                    <form class="form-horizontal mt0" action="login-employer.html" id="login-form" role="form">
                        ...
                        <input type="submit" class="col-md-6 btn" id="subcbtn" value="Send"/>
