...
if(isset($_POST['submit'])){
  ...
  if(array_filter($errors)){
    //echo errors in form
      ...
      // Insertion query
			$sql_2 = "INSERT INTO `member`(`type`, `name`,`iobm_id`, `email`, `photo`, `dob`, `contact`, `address`, `semester`, `courses`, `transcript`,`cv`, `password`, `status`)
      VALUES ('$mtype','$name','$iobmId','$email','$photo','$dob','$contact','$address','$semester','$courses','$transcript','$cv','$passwordEnc','$status')";
