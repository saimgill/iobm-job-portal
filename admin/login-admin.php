...
include("includes/login-admin.inc.php");
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Login | The IoBM Job Portal</title>
            ...
            <div class="login-panel panel panel-default plain animated bounceIn">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title text-center">
                        ...
                        <img id="logo" src="img/logo-dark.png" alt="Dynamic logo" class="col-md-8">
                    </h4>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal mt0" action="login-admin.php" method="POST" id="login-form" role="form">
                        <div class="form-group">
                            <div class="col-lg-12">
                                <div class="input-group input-icon">
                                    <span class="input-group-addon"><i class="fa fa-envelope"></i></span>

                                    <input type="text" name="email" id="email" class="form-control" value="" placeholder="Your email ...">
